...
<!--      <el-upload action :http-request="upload" :multiple="false" :show-file-list="false"-->
<!--                 :data="fileData" :on-success="handleAvatarSuccess" :before-upload="beforeAvatarUpload">-->
<!--        <el-button slot="trigger" size="small" type="primary">上传头像</el-button>-->
<!--        <div slot="tip" class="el-upload__tip">只能上传jpg文件，且不超过2MB</div>-->
<!--      </el-upload>-->
<!--        <myUpload v-model="showDialog"  :url="http://localhost:8081/upload"></myUpload>-->
      <div class="tip">
        建议上传您的职业照或者证件照
        <br>
        头像将会和您的基本信息一同展示给企业
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.avatarURL = "http://localhost:8081/avatar?path=" + this.student.id + this.student.username + ".jpg";
