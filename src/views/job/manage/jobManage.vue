...
<!--    <el-table :data="jobs" class="job-table" highlight-current-row>-->
...
<!--          -->
<!--        </el-popconfirm>-->
        <el-button type="danger" icon="el-icon-delete" size="mini" @click="deleteJob(scope.row.id, scope.row.name, scope.$index)" circle/>
      </template>
    </el-table-column>
  </el-table>
</template>
